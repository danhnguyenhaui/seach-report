	...
	<div class="container" id="container">
		<div class="card card-outline-primary">
			<div class="card-header">
				<h5 class="card-title">Chỉnh sửa báo cáo</h5>
			</div>
			<div class="card-body">
				<form class="mx-5 my-5" action="http://localhost:8080/SearchReport/ReportController" enctype="multipart/form-data" method="post">
					<div class="form-group">
						<label for="reportName">Tên báo cáo</label> 
						<input value="${report.reportName }" type="text" class="form-control" id="reportName" name="reportName"> 
						<small id="reportNameHelp" class="form-text text-muted">
							Tên báo cáo từ 10 - 100 ký tự.
						</small>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<textarea class="form-control" id="description" rows="3" name="description"><c:out value="${report.description }"></c:out> </textarea>
					</div>
					<div class="form-group">
					...
					<input id="btn_upload" type="submit" class="btn btn-primary" value="Xác nhận"/>
				</form>
				<!--// form-->
			</div>
			<!--// card .card-body-->
